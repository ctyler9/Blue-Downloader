...
{
    UIAlertView *alertView = [[[UIAlertView alloc] initWithTitle:@"Welcome!" message:[NSString stringWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"first_run_message" ofType:@""] encoding:NSASCIIStringEncoding error:nil] delegate:nil cancelButtonTitle:@"Sounds Good" otherButtonTitles:nil] autorelease];
    [alertView show];
}
